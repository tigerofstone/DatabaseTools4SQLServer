...
namespace Upgrade.UpGradeApp
{
	...
	/// </summary>
	public class UpdateDBObject2TemplateStartForm : System.Windows.Forms.Form
	{
		...
		public UpdateDBObject2TemplateStartForm()
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		private void InitializeComponent()
		{
			...
			// btnUpdate
			// 
			this.btnUpdate.Location = new System.Drawing.Point(668, 103);
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(36, 106);
		...
		private void UpdateDBObject2TemplateStartForm_Load(object sender, System.EventArgs e)
		{
			this.tnUpdate_Click(sender, e);
